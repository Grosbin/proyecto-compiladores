...
root.geometry('600x500+{}+{}'.format(x, y))
...
calcular_entrada_btn = tk.Button(
    root, text="Calcular entrada", command=lambda: calcular("entrada"), **button_style)

calcular_archivo_btn = tk.Button(
    root, text="Calcular archivo txt", command=lambda: calcular("archivo"), **button_style)
...
# Configurar la etiqueta de resultado
# resultado_label = tk.Label(root, text="", fg="white", bg="#000", font=("Helvetica", 18))
# resultado_label.pack(side="bottom", pady=20)
# Configurar la etiqueta de resultado
tokens_data_label = tk.Label(
    root, text="", fg="white", bg="#000", font=("Helvetica", 18))
